# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-05-16 16:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='myshop.Category', verbose_name='\u041a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044f')),
            ],
            options={
                'ordering': ['name'],
            },
